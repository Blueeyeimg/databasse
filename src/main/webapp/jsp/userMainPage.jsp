            ...
            <div class="span3">
                <div class="sidebar">
                    ...
                    <ul class="widget widget-menu unstyled">
                        ...
                        <li><a href="index.jsp"><i class="menu-icon icon-paste"></i>Forms </a></li>
                        <li><a href="../jsp/showUser.jsp"><i class="menu-icon icon-table"></i>Tables </a></li>
                        <li><a href="jsp/charts.html"><i class="menu-icon icon-bar-chart"></i>Charts </a></li>
                    </ul>
                    <!--/.widget-nav-->
                    <ul class="widget widget-menu unstyled">
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                        <a href="#" class="btn-box small span4"><i class="icon-save"></i><b>Total
                                            Sales</b>
                                        </a><a href="#" class="btn-box small span4"><i class="icon-bullhorn"></i><b>Social
                                        Feed</b>
...
<div class="footer">
    <div class="container">
        <b class="copyright">&copy; 2014 Edmin - EGrappler </b>All rights reserved. More Templates <a
...
<script src="../assets/jquery/flot/jquery.flot.resize.js" type="text/javascript"></script>
<script src="../assets/jquery/datatables/jquery.dataTables.js" type="text/javascript"></script>
<script src="../assets/jquery/common.js" type="text/javascript"></script>
